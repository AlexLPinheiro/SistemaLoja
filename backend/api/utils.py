...
def get_cotacao_dolar_com_encargos():
    """
    Busca a cotação atual do dólar, aplica os encargos e armazena em cache.
    Esta função será usada para o Dashboard e para o momento de criação de um pedido.
    """
    ...
    # Constantes para os encargos e taxas
